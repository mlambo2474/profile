  ...
  return (
    ...
    >
      <h1 className="text-2xl sm:text-5xl font-bold text-white mb-4">
        ...
        <span className="inline-block w-[2px] h-4 lg:h-9 bg-indigo-600 animate-blink ml-1"></span>
      </h1>
      <p className="hidden lg:block text-white text-base sm:text-lg leading-relaxed">
        ...
        responsive, user-focused mobile and web applications using <br />
        <span className="bg-pink-300 px-3 mx-1 font-bold text-sm rounded-lg text-black">
          HTML
        </span>
        <span className="bg-pink-300 px-3 mx-1 font-bold text-sm rounded-lg text-black">
          CSS
        ...
        efficient code and constantly learning new tools to level up my craft.
      </p>
    </motion.div>
  );
};
