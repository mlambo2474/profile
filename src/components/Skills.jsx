      ...
      >
        ...
        >
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Mobile‑first layouts that adapt beautifully across phones,
              tablets, and desktops. I design with fluid grids, flexible media,
              and accessible patterns to ensure consistent experiences.
              Performance and readability guide every breakpoint.
            </p>
          </div>
          <div className="px-6 pb-6">
            <a
              href="#"
              className="inline-block text-sm font-semibold text-pink-400 hover:text-pink-600 transition-colors"
            >
        ...
        >
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Fast, app‑like experiences powered by client‑side rendering and
              smart state. I craft seamless flows, page transitions, and data
              fetching that feel instant, scalable, and maintainable.
            </p>
          </div>
          <div className="px-6 pb-6">
            <a
        ...
        >
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Robust, accessible UIs engineered for clarity, speed, and
              long‑term growth. From semantic HTML to optimized assets and
              testing, I focus on quality that scales with your product.
            </p>
          </div>
          <div className="px-6 pb-6">
            <a
